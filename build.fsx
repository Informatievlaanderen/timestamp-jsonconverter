...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.Converters.Timestamp")

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.Converters.Timestamp")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.Converters.Timestamp")
